...
var ninoApplications = require('../../public/v6/javascripts/nino_applications.json')
...
var falloutRoutes = require('./router/fallout_routes');
var applyForNinoRoutes = require('./router/apply-for-a-nino_routes');
...
router.use('/', main,
  ...
  req.session.data.cis = require('../../public/v6/javascripts/cis.json');
